              ...
              <n-space vertical style="margin-top: 10px">
                ...
                <n-space @click="toGameDetailsPage(match.gameId)">
                  ...
                  <n-space vertical :size="[10, -2.4]">
                    <n-space :size="[5]">
                      <n-tag
                        ...
                        >{{ match.isWin }}</n-tag
                      >
                      <n-tag type="error" :bordered="false" v-else>{{
                        match.isWin
                      }}</n-tag>
                      <img class="itemClass" :src="match.spell1Id" alt="" />
                      <img class="itemClass" :src="match.spell2Id" alt="" />
                    </n-space>
                    <span style="color: #9aa4af; font-size: 13px">{{
                      match.queueId
                    }}</span>
                  </n-space>
                  <!--          装备 战绩 补兵 经济-->
                  <n-space style="" :size="[2, -2]" vertical>
                    <n-space :size="[2]">
                      <img class="itemClass" :src="match.item0" />
                      <img class="itemClass" :src="match.item1" />
                      <img class="itemClass" :src="match.item2" />
                      <img class="itemClass" :src="match.item3" />
                      <img class="itemClass" :src="match.item4" />
                      <img class="itemClass" :src="match.item5" />
                      <img class="itemClass" :src="match.item6" />
                    </n-space>
                    <n-space :size="[9]">
                      ...
                      <div style="color: #9aa4af; font-size: 13px; width: 32px">
