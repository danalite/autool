<template>
  <rune class="slide-in-bottom"></rune>
</template>
...
} from "@/utils/render/blacklistUtils";
...
onMounted(() => {
  ...
  let champRank = document.querySelector(
    "#app > div.n-tabs.n-tabs--segment-type.n-tabs--medium-size > div > div > div:nth-child(1) > div"
  );
  let rune = document.querySelector(
    "#app > div.n-tabs.n-tabs--segment-type.n-tabs--medium-size > div > div > div:nth-child(2) > div.n-tabs-tab"
  );
  nTabsRail.style.margin = "12px 12px 0 12px";
  champRank.style["border-radius"] = "5px";
  champRank.style["transition"] =
    "box-shadow 1s var(--n-bezier),\n" +
